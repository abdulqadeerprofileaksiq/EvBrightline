  ...
  const handleVerify = () => {
    ...
    if (otpValue.length === 6) {
      ...
      setTimeout(() => {
        ...
        // Navigate based on which screen the user came from
        if (fromScreen === 'forgotPasswordScreen') {
          // For forgot password flow, go to create new password
          router.push({
            pathname: '/createPassword',
            params: { heading: 'Create New Password' }
          });
        } else {
          // For registration flow, go to create password
          router.push({
            pathname: '/createPassword',
            params: { heading: 'Create Password' }
          });
        }
      }, 1500);
    }
