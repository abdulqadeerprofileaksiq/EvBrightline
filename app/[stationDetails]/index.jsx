...
const ChargingStationDetailScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Header Image - Outside of SafeAreaView */}
      ...
      {/* SafeAreaView wrapping the content */}
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.infoContainer}>
            <HeadingText
              text="Veen Charging Station"
              textStyles={styles.stationName}
            />

            <View style={styles.addressRow}>
              <Ionicons name="location-outline" size={16} color="#F59E0B" />
              <RegularText
                text="21212 Co Rd 742, Airport, United States"
            ...
            <View style={styles.distanceRow}>
              ...
              <RegularText
                text="2.5km/15 mins away"
                textStyles={styles.distanceText}
              />
            </View>
            ...
            <View style={styles.sectionContainer}>
              ...
              <TouchableOpacity style={styles.directionButton}>
                <RegularText
                  text="Direction"
                  textStyles={styles.directionButtonText}
                />
